CREATE DATABASE  IF NOT EXISTS `db_librarysys` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db_librarysys`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
-- Host: localhost    Database: db_librarysys
-- ------------------------------------------------------
...
INSERT INTO `tb_bookcase` VALUES (4,'左A-1'),(5,'左A-2'),(6,'右A-1');
...
INSERT INTO `tb_bookinfo` VALUES ('9787302210337','Java Web开发实战宝典',4,'王国辉','','302',89.00,834,4,'2017-02-24','mr',0,7),('9787115195975','Java Web开发典型模块大全',4,'王国辉、王毅、王殊宇','','115',89.00,752,5,'2017-02-24','mr',0,8),('4521212','njknjn',5,'mnm','','115',11.00,0,4,'2017-02-24','mr',1,9),('gf','gfhgf',4,'','','111',26.00,0,4,'2017-02-24','mr',1,10);
...
INSERT INTO `tb_booktype` VALUES (4,'网络编程',20),(5,'数据库开发',15);
...
INSERT INTO `tb_borrow` VALUES (7,4,7,'2017-02-24','2017-03-16','mr',1),(8,4,7,'2017-02-24','2017-03-16','mr',0),(9,5,8,'2017-02-24','2017-04-05','mr',0);
...
INSERT INTO `tb_giveback` VALUES (3,4,7,'2017-02-24','mr');
...
INSERT INTO `tb_manager` VALUES (1,'mr','mrsoft'),(7,'wgh','111'),(9,'admin','111'),(10,'mingrisoft','mingrisoft');
...
INSERT INTO `tb_purview` VALUES (1,1,1,1,1,1),(7,0,1,1,1,1),(9,1,1,1,0,0),(10,0,0,0,0,1);
...
INSERT INTO `tb_reader` VALUES (4,'琦琦','女','20170224000001','学生','2010-07-10','身份证','220104201007100001','84978981','wgh717@sohu.com','2017-02-24','mr','无',4),(5,'wgh','女','20170224000002','程序员','1980-07-10','工作证','20010228','84978981','wgh717@sohu.com','2017-02-24','mr','无',4),(6,'uui','男','iuoui','',NULL,'身份证','iuoi','','nmb','2017-02-24','mr','',4);
...
--
-- Dumping routines for database 'db_librarysys'
--
...
-- Dump completed on 2017-03-02 10:56:02
